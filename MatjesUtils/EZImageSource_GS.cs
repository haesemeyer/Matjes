...
namespace MatjesUtils {
    /// <summary>
    /// Image source for grayscale images
    /// </summary>
    public unsafe sealed class EZImageSource_GS : EZImageSource {
        ...
        public override void Write(Image8 image, WaitHandle cancel) {
            if (IsDisposed)
                throw new ObjectDisposedException(nameof(EZImageSource_GS));
